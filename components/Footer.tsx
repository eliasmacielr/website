  ...
  return (
    <footer className='flex flex-col items-center bg-slate-800 text-gray-200'>
      ...
      <div className="fixed bottom-0 left-0">
        <svg className="mb-4" id='move-y' xmlns="http://www.w3.org/2000/svg" width="20px" height="19px" viewBox="0 -442 490 647" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" style={{}}>
          <defs>
