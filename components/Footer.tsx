  ...
  return (
    <footer className='flex flex-col items-center bg-slate-800 text-gray-200'>
      ...
      <div className="fixed bottom-0 left-0">
        <svg className="relative left-10 bottom-10 text-red-600 " id='move-y' xmlns="http://www.w3.org/2000/svg" width="21.507px" height="29.28px" viewBox="0 -442 490 647" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" style={{}}>
          <defs>
        ...
        <svg className="absolute left-1.5 bottom-0 text-red-600" height="30" width="7" id='expand-up'>
          <line x1="0" y1="0" x2="0" y2="100vh" style={{stroke:'currentcolor', strokeWidth:10}} />
          Sorry, your browser does not support inline SVG.
        </svg>

        <svg className="relative text-red-600" id='arrow-up' xmlns="http://www.w3.org/2000/svg" width="22px" height="16.1636px" viewBox="0 -575 722 595"   
