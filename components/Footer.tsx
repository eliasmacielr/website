  ...
  return (
    <footer className='flex flex-col items-center bg-slate-800 text-gray-200'>
      ...
      <div className="fixed bottom-0 left-0">
        <svg className="mb-4" id='move-y' xmlns="http://www.w3.org/2000/svg" width="21.507px" height="29.28px" viewBox="0 -442 490 647" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" style={{}}>
          <defs>
          ...
          </defs><g stroke="red" fill="red" stroke-width="0" transform="scale(1,-1)"><g data-mml-node="math"><g data-mml-node="mi"><use data-c="1D466" href="#MJX-13-TEX-I-1D466"></use></g></g></g>
        </svg>
        <svg className="relative left-1.5" height="30" width="7" id='expand-up'>
          <line x1="0" y1="0" x2="0" y2="100vh" style={{stroke:'rgb(255,0,0)', strokeWidth:10}} />
          Sorry, your browser does not support inline SVG.
        </svg>

        <svg className="absolute" id='arrow-up' xmlns="http://www.w3.org/2000/svg" width="22px" height="16.1636px" viewBox="0 -575 722 595"   
          ...
          </defs><g stroke="red" fill="red" stroke-width="0" transform="scale(1,-1)"><g data-mml-node="math"><g data-mml-node="mi"><use data-c="25B4" href="#MJX-12-TEX-I-25B4"></use></g></g></g>
        </svg>
      </div>
      <div className="fixed bottom-0 left-0">
        ...
        <svg className='absolute bottom- left-29px -bottom-0.5'id='move-right' xmlns="http://www.w3.org/2000/svg" width="24px" height="14.1636px" viewBox="0 -539 778 580" xmlnsXlink="http://www.w3.org/1999/xlink"   aria-hidden="true" style={{}}>
          <defs>
        ...
        <svg className='absolute bottom- left-29px -bottom-0.5'id='move-right-x' xmlns="http://www.w3.org/2000/svg" width="22.035px" height="20.495px" viewBox="0 -442 572 453" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" style={{}}>
          <defs>
