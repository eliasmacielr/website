  ...
  return (
    <header className="flex flex-col items-center bg-slate-800 text-gray-200">
      ...
      <div className="hidden lg:text-xl lg:flex flex-col lg:flex-row lg:justify-center lg:py-4 lg:gap-8 mb-4 lg:mb-0">
        <Link className="py-1 px-8" href="/">Home</Link>
        <Link className="py-1 px-8" href="/projects">Projects</Link>
        <Link className="py-1 px-8" href="/courses-teaching">Courses &amp; Teaching</Link>
        <Link className="py-1 px-8" href="/contact-info">Contact &amp; Info</Link>
      </div>
      {/* Mobile nav */}
      <div className="topnav w-full lg:w-auto lg:hidden">
        <div id="myLinks" className="hidden flex-col mb-4 lg:mb-0">
          <Link className="py-1 px-8" href="/">Home</Link>
          <Link className="py-1 px-8" href="/projects">Projects</Link>
          <Link className="py-1 px-8" href="/courses-teaching">Courses &amp; Teaching</Link>
          <Link className="py-1 px-8" href="/contact-info">Contact &amp; Info</Link>
