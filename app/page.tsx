    ...
    <div className="px-8 lg:p-0">
      ...
      <section className="lg:grid lg:grid-cols-3 mb-16">
        ...
        <div className="col-span-2">
          ...
          <dl className="mb-8">
            <dt>
              <p className="font-bold">Cluster de Investigación Aplicada (CIA) &mdash; FP-UNA</p>
            </dt>
            <dd>
      ...
      <section className="lg:grid lg:grid-cols-3">
        ...
        <div className="col-span-2">
          <dl className="mb-8">
            ...
            <dd>
              <p>Master of Science in Computer Science, 2021<br />
              Advisors: Christian Schaerer and Inocencio Ortiz<br />
              Thesis: Proposal of Geometric Integrator for Nonconservative, Nonholonomic Mechanical Systems</p>
            </dd>
          </dl>
          <dl>
            <dt>
            ...
            <dd>
              <p>Bachelor of Science in Information Technology, 2017<br />
              Advisor: Prof. Christian Schaerer<br />
              Thesis: Evaluation of Block Conjugate Gradient for a Single Right-Hand Side <Link href="http://www.cc.pol.una.py/~cschaer/Tesis-Elias%20Maciel.pdf">[PDF]</Link></p>
            </dd>
          </dl>
        </div>
      </section>
      ...
      <section className="lg:grid lg:grid-cols-3 mb-16">
        ...
        <div className="col-span-2">
          <ul>
            <li>
              CILAMCE 2020, XLI Ibero-Latin American Congress on Computational Methods in Engineering,
              16 - 19 November, 2020 - On-line.
            </li>
            <li>
              <Link href="http://sociedadcientifica.org.py/encuentrodeinvestigadores-convocatoria-2020/" target="_blank">V Encuentro de Investigadores</Link>,
              9 - 12 de noviembre de 2020 - Online.
            </li>
            <li>
              <Link href="http://sociedadcientifica.org.py/un-encuentro-para-celebrar-y-discutir-la-ciencia-que-se-construye-en-paraguay/" target="_blank">IV Encuentro de Investigadores</Link>,
              6 - 8 de noviembre de 2019 - Sociedad Científica del Paraguay, Asunción, Paraguay.
            </li>
            <li>
              <Link href="http://sociedadcientifica.org.py/el-22-de-agosto-inicia-el-ii-encuentro-de-investigadores/" target="_blank">II Encuentro de investigadores</Link>,
              22 - 25 de agosto de 2017 - Sociedad Científica del Paraguay, Asunción, Paraguay.
            </li>
            <li>
              <Link href="http://www.cc.pol.una.py/events/metting-in-applied-scientific-computing/" target="_blank">Meeting in Applied Scientific Computing</Link>,
              Thursday 20/July/2017 9:00 hs NIDTEC - Facultad Politécnica - San Lorenzo, Paraguay.
            </li>
            <li>
              <Link href="http://www.epacis.net/ccis2016/en/index.php" target="_blank">
              CCIS 2016 - 4th Conference of Computational Interdisciplinary Sciences</Link>,
      ...
      <section className="lg:grid lg:grid-cols-3">
        ...
        <div className="col-span-2">
          <ul>
            <li>
              <Link href="docs/Integrador_geom_trico_de_contacto_con_restricciones_no_holon_micas___Poster_V_Encuentro_de_Investigadores_2020.pdf" target="_blank">Integrador geométrico de contacto con restricciones no holonómicas</Link>
            </li>
            <li>
              <Link href="docs/Presentaci_n_de_Integrador_de_Contacto_para_el_Disco_Controlado_que_rueda_sin_deslizamiento.pdf" target="_blank">Integrador de Contacto para el Disco Controlado que rueda sin deslizamiento</Link>
            </li>
            <li>
              <Link href="docs/SpMV_and_SpMM_Performance_Measurement___CCIS_2016.pdf" target="_blank">SpMV and SpMM Performance Measurement</Link>
            </li>
            <li>
              <Link href="docs/WPFG___Presentaci_n.pdf" target="_blank">Evaluación de las rutinas de multiplicación sobre matrices dispersas</Link>
            </li>
          </ul>
        </div>
      </section>
