...
export default function ContactInfo() {
  return (
    <MainLayout>
      ...
      <br />
      <a href="https://www.linkedin.com/in/eliasmacielr/" target="_blank" rel="noreferrer">
        <img src="img/LI-In-Bug.png" alt="LinkedIn Logo" style={{ height: '32px' }}/>
      </a>
      <a href="https://github.com/eliasmacielr" target="_blank" rel="noreferrer">
        <img src="img/GitHub-Mark-32px.png" alt="GitHub Logo" style={{ height: '32px', width: '32px' }}/>
      </a>
      <a href="https://twitter.com/eliasmacielr" target="_blank" rel="noreferrer">
        <img src="img/Twitter_Social_Icon_Circle_Color.png" alt="Twitter Logo" style={{ height: '32px', width: '32px' }}/>
      </a>
      <a href="https://www.facebook.com/profile.php?id=100080232595377" target="_blank" rel="noreferrer">
        <img src="img/f_logo_RGB-Blue_58.png" alt="Facebook Logo" style={{ height: '32px', width: '32px' }}/>
      </a>
      <a href="https://www.instagram.com/eliasmacielcc/" target="_blank" rel="noreferrer">
